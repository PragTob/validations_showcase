...
RSpec.describe PracticesController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: practice.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      practice = Practice.create! valid_attributes
      get :edit, params: {id: practice.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Practice" do
        expect {
          post :create, params: {practice: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {practice: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested practice" do
        practice = Practice.create! valid_attributes
        put :update, params: {id: practice.to_param, practice: new_attributes}, session: valid_session
        practice.reload
      ...
      it "redirects to the practice" do
        practice = Practice.create! valid_attributes
        put :update, params: {id: practice.to_param, practice: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        practice = Practice.create! valid_attributes
        put :update, params: {id: practice.to_param, practice: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested practice" do
      practice = Practice.create! valid_attributes
      expect {
        delete :destroy, params: {id: practice.to_param}, session: valid_session
      }.to change(Practice, :count).by(-1)
    end
